...
This is a summary of the [CASTEP (web)](http://www.castep.org/) software for DFT calculations. These notes can be consulted on [GitHub](https://github.com/pablogila/castep4dummies).  
