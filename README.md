# Benefits and Risks of AI tools for Scientific Research
...
Too many AI tools have spawned in the last months, but only a few seem useful for our academic duties. Here we will only focus on the most useful ones.  
...
Please be cautious with AI-generated results. LLMs will always answer, yet sometimes they will not know anything about the subject and answer anyway. You need to think critically and verify that the information is correct. These models also have biases in their training data, so be careful.  
...
google project tailwind to synthetise will come on g.co/Labs
